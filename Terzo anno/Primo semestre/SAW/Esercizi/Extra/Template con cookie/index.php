...
<div class="form-container">
		...
		<form method="POST" action="registration.php">
			...
			<input type="email" id="email" name="email" placeholder="e.g. mario.rossi@gmail.com">
			<br><br><label for="password">Password</label><br>
			<input type="password" id="password" name="password" placeholder="Password" pattern="[0-9]{3}">
			<br><br><label for="confirm">Conferma password</label><br>
			<input type="password" id="confirm" name="confirm" placeholder="Password" pattern="[0-9]{3}">
			<br><br>
